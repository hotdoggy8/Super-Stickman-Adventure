...
#Made by N.M.Khoi and with help of L.V.Hoang
...
def RenderSprite(sprclass, type):
    ...
    if type == "player":
        if sprclass.color == "yellow":
            ...
            elif sprclass.frame == 4:
                #Jumping-yellow
                ImagePath = "Images/Stickman_jump_yellow.png"
            ...
            if sprclass.frame == 1:
                ...
                #Jumping-red
                ImagePath = "Images/Stickman_jump_red.png"
            ...
            if sprclass.frame == 1:
                ...
                #Jumping-green
                ImagePath = "Images/Stickman_jump_green.png"
            ...
            if sprclass.frame == 1:
                ...
                #Jumping-blue
                ImagePath = "Images/Stickman_jump_blue.png"
...
obbylevelarray = []
obbylevelfblocks = []
LoadLevel("obby", obbylevelarray, obbylevelfblocks)
...
# *Just use the hitbox. It'll help :)
while Running:
    ...
    if Process == 0:
        ...
        titletext = pygame.font.Font(globalfont, 12).render("Pre-alpha 0.0B1", False, (255, 255, 255))
        ...
        playerhitbox = pygame.rect.Rect(mainplayer.PosX + 20, mainplayer.PosY + 23, 47, 77)
        pygame.Surface.set_colorkey(playersprite, (255, 255, 255))
        playerhitbox.x += globalxshift
        playerhitbox.y += 1
        if not spawned:
            spawned = True
            for fblock in obbylevelfblocks:
                if fblock[0] == "Spawn":
        ...
        if jumpupdated:
            if mainplayer.PosY - jmpstartY > -38*3:
                ...
                jumpupdated = False
                canjump = False
        for blockdata in obbylevelarray:
            blockvrect = pygame.rect.Rect(blockdata[1], blockdata[2], 38.0, 38.0)
            if not jumping:
                if playerhitbox.colliderect(blockvrect):
        ...
        if mainplayer.touchingpart == None:
            ...
            canjump = True
        window.blit(background, (0, 0))
        for renderdata in obbylevelarray:
            if (not (renderdata[1] - globalxshift < -38)) and (not (renderdata[1] - globalxshift > 1200)):
                window.blit(renderdata[0], (renderdata[1] - globalxshift, renderdata[2]))
